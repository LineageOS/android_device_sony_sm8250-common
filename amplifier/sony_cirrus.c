...
int amplifier_enable_devices(uint32_t devices, bool enable);  // audio_extn_spkr_prot_start_processing / stop_processing
...
int amplifier_close(void);  // audio_extn_spkr_prot_deinit()
